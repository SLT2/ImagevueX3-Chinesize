...
Class Cache {
  ...
  function create($route, $file_path, $current_page = false, $include = true) {
    ...
    if(!is_writable($dir)) {
  	...
  	if($include){
	  	...
	  	include './app/parsers/php-markdown-lib/Michelf/MarkdownExtra.inc.php';
			...
			include './extensions/twig-extensions.inc.php';
			include './extensions/twig.imagevue.inc.php';
			include './extensions/exif_reader.php';
  	}
    ...
    # create page
    $page = new Page($route, false, $file_path, $current_page);
