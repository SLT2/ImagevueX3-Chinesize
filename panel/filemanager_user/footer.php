...
?>
    ...
    <?php
    if(isset($settings) && $settings->ticket == "on")
    {
    ?>
    ...
    {
        $('#preloader').modal('show');
        $.post("filemanager_user/ajax_show_setting.php",
        {
            showSetting:<?php echo $core->user_id;?>
        },
        function(data,status)
        {
            if(status == "success")
    ...
    function show_left_folder_menu()
    {
        if( !reload_sidebar ) {
            ...
            $('#left_folder_menu_box').load('filemanager_user/x3_menu.php', {dir:'<?php echo $core->user_dir;?>/'}, function() {
            ...
            /*$('#left_folder_menu_box').leftFileTree({
                root: '<?php echo $core->user_dir;?>/',
                script: 'filemanager_user/folderMenu.php',
                expandSpeed: 100,
                collapseSpeed: 100,
                multiFolder: false
            }, function(file) {
